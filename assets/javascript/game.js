...
var capitals = ["amsterdan", "ankara", "astana", "asuncion", "athens", "baghdad", "bangkok", "beirut", "bogota", "brasilia", "caracas", "copenhagen", "damascus", "dublin", "hanoi", "havana", "helsinki", "jakarta", "kiev", "lima", "luxembourg", "madrid", "managua", "montevideo", "nairobi", "niamey", "ottawa", "quito", "rabat", "reykjavik", "santiago", "seoul", "stockholm", "ulaanbaatar", "washington", "yaounde"];
...
var numLosses = 0;
var getNewWord;
var wordPlace; //place in capitals array
var correctGuesses;
var wordAsArr = [];
var dashesArray = [];
...
function initialize() {
	...
	currentWord = capitals[wordPlace];			//string
